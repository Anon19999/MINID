...
# mat = scipy.io.loadmat('canondataset_approx_spec.mat')
# SpecData=mat['canondataset_approx_spec']
#
# mat = scipy.io.loadmat('halftone_canon.mat')
# HalftoneData=mat['halftone_reshape']
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        loss = criterion_RMSE(spec_all, outputs_all)
        # loss = ((lab_color_gt - lab_color_output)**2).mean(axis=None)
        print('Validataion RMSE is: {}'.format(loss))


# save the model
torch.save(model_HalftoneTospec.state_dict(), '8ink_net_4lay_150.ckpt')
