...
mat = scipy.io.loadmat('spec_dataset.mat')
SpecData=mat['spec_dataset']
...
train_loader = torch.utils.data.DataLoader(dataset=train_dataset, batch_size=31*10)
...
# save the model
torch.save(model_HalftoneTospec.state_dict(), '44ink_net_50_50.ckpt')
