...
mat = scipy.io.loadmat('spectrum.mat')
SpecData=mat['spectrum_adj']

mat = scipy.io.loadmat('ink_dset.mat')
HalftoneData=mat['ink_dset']
...
# save the model
torch.save(model_HalftoneTospec.state_dict(), 'contoning_net_test.ckpt')
